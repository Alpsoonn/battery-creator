  ...
  let manualControllerAspectLocked = true;
  let manualPointerFrame = null;
  let manualPendingPointer = null;
  let manualClickSuppressed = false;
  let manualControllerFieldBefore = null;
  let manualLastCellClickId = null;
  let manualLastCellClickAt = 0;
  let manualSuppressNextClick = false;
  ...
  let stage2Notice = "";
  let manualDrag = null;
  let manualCellPaint = null;
  let manualCellPaintFrame = null;
  let manualCellPaintPendingPointer = null;
  let manualSuppressNextContextMenu = false;
...
let boundaryImageAspectLocked = true;
let boundaryImageCalibration = { active: false, points: [] };
let boundaryImagePointerFrame = null;
let boundaryImagePendingPointer = null;
let boundaryImageFieldBefore = null;
